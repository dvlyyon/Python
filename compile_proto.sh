...
python -m grpc_tools.protoc -I=$proto_imports --python_out=. --pyi_out=. --grpc_python_out=. $proto_dir/gnmi.proto
python -m grpc_tools.protoc -I=$proto_imports --python_out=. --pyi_out=. --grpc_python_out=. $proto_dir/gnmi_ext.proto
